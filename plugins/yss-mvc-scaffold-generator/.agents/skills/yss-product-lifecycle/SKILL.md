...
交付前按 `docs/process/development-gate.md` 提升正式资产到稳定路径并刷新受影响证据；保留功能包中的引用和历史过程记录。消费验收入口输出的 task/integration 作用域与 files、build、production-assembly、external-integration、deployment 各层状态，未验证层不能用整体完成措辞代替。
