...
GOVERNANCE_FILES.push('scripts/inspect-artifact-lifecycle.mjs','scripts/lib/artifact-lifecycle.mjs','scripts/lib/delivery-results.mjs','scripts/lib/workspace-ownership.mjs');
